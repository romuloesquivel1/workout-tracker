<template>
  <div class="w-full flex flex-col items-center py-2">
    <div class="container mx-auto px-6">
      ...
      <h3 class="text-2xl mb-6 text-grey-dark text-center">
...
const featureLists = [
  {
    title: 'Very Fast',
    description: 'We use best technology to make our website very fast',
  ...
  {
    title: 'Secure',
    description: 'Your data is safe with us. We use best security practices',
    icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
  ...
  {
    title: 'Easy to Use',
    description: 'Our website is very easy to use. You can create workout in minutes',
    icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
  ...
  },
  {
    ...
    description: 'You can customize our website to your liking',
    icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
  ...
  },
  {
    ...
    description: 'Our website is mobile friendly. You can use it on any device',
    icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
  ...
  {
    title: '24/7 Support',
    description: 'We provide 24/7 support for our customers',
    icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
...
const columns1 = featureLists.slice(0, 3);
const columns2 = featureLists.slice(3, 6);
